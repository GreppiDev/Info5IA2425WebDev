...
var host = builder.Configuration["MARIADB_HOST"] ?? "mariadb";
var port = builder.Configuration["MARIADB_PORT"] ?? "3306";
var database = builder.Configuration["MARIADB_DATABASE"] ?? "pizza_store";
var user = builder.Configuration["MARIADB_USER"] ?? "pizza_user";
var password = builder.Configuration["MARIADB_PASSWORD"] ?? "change-me";
...
builder.Services.AddDbContext<PizzaDb>(dbContextOptions =>
{
